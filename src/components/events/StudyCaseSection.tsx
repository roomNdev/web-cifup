...
const StudyCaseSection: React.FC<{}> = () => {
    ...
    return (
        <StudyCaseSectionStyles>
            ...
            <div className='video'><blockquote
  className="instagram-media"
  data-instgrm-permalink="https://www.instagram.com/reel/C4ymZNWPRJj/?utm_source=ig_embed&utm_campaign=loading"
...
>
  <div style={{ padding: 16 }}>
    {" "}
    <a
      href="https://www.instagram.com/reel/C4ymZNWPRJj/?utm_source=ig_embed&utm_campaign=loading"
      style={{
        background: "#FFFFFF",
        lineHeight: 0,
        padding: "0 0",
    ...
    >
      <a
        ...
        target="_blank"
      >
        Una publicación compartida por CIFUP (@cif_up)
      </a>
    </p>
  </div>
</blockquote>
